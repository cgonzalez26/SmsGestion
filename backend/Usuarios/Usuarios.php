<?php 
	...
	$oXajax->register( XAJAX_FUNCTION , 'DatosUser');
	$oXajax->register( XAJAX_FUNCTION , 'updateDatosUser');	
	$oXajax->processRequest();					
	$oXajax->printJavascript( "../includes/xajax/");
	

	$array = $oMysql->consultaSel("CALL usp_getSelect(\"\",\"\",\"\",\"\");");
	
	$aOpciones['optionsTiposUsuarios'] = $oMysql->getListaOpciones('tiposusuarios','id','sNombre');
	...
	$body = xhtmlTablaABM($aOpciones,'Usuarios');
