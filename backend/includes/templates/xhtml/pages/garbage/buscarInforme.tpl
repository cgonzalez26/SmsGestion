...
<div class='cuerpo'>
	<!-- BLOCK VOLVER_URL --> <a style='text-align: right; float: right; position: relative; top: 5px;right:50px; font-size: 9pt; ' href='{*}'>Volver</a> <!-- END -->
	...
	<h4 class='titulo'>  Buscar Informes  </h4>
