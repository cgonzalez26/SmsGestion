...
<div id="GrillaGeneral" style='padding-left:10px;padding-right:10px;'>
	...
	<table cellpadding='0' cellspacing='0' width='80%' class='TablePermits'>
		<tr>
			<td class='title' width='100' style="height:30px;padding-left:20px"><img src="../includes/images/internas/icon-16-grupo.png" border="0" style="width:16px;height:16px" />&nbsp;&nbsp;<strong>Administrar Unidades de Negocios</strong></td>
		</tr>
	</table>
...
<div id='divPermits' style='margin-left:10px;margin-right:10px;'>
	...
	<input type="hidden" id="idUnidadNegocio" name="idUnidadNegocio" value=0 />
	<fieldset style="background:#F5F5F5;">
	<legend>Datos de la Unidad de Negocio:</legend>
...
<script>
	...
	var flds = "Codigo,Nombre,E-mail";
	
	mygrid.setHeader(flds);

	mygrid.setInitWidths("1,200,400");
	
	mygrid.setColAlign("left,left,left");	
	
	mygrid.setColTypes("ed,ed,co");
	
    var sColumnas="id,sNombre,sMail";
    ...
    function doOnEnter(id){
		xajax_getDatosUnidadNegocio(id);
	}
	...
	function sendForm(){
		...
		xajax_updateDatosUnidadNegocio(xajax.getFormValues('form'));
	}	
