<!-- DEFINE LISTA_TIPOS_ESTADOS getListaTiposEstadosPersonal() -->

<fieldset class='border'>
	
	<div>
		<label for='idTipoEstadoPersonal' class='middle'> Concepto (*): </label>
		<select id='idTipoEstadoPersonal' name='idTipoEstadoPersonal'>
...
<script type='text/javascript'>
	...
	<!-- BLOCK DATOS -->
		...
		document.getElementById('idTipoEstadoPersonal').value = '{idTipoEstadoPersonal}';
