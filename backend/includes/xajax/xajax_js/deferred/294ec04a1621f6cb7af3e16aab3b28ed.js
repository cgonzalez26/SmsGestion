...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_getDatosGrupo=function(){return xajax.request({xjxfun:'getDatosGrupo'},{parameters:arguments});};xajax_enviarMailsCampaniasNuevo=function(){return xajax.request({xjxfun:'enviarMailsCampaniasNuevo'},{parameters:arguments});};xajax_getMailUnidadNegocio=function(){return xajax.request({xjxfun:'getMailUnidadNegocio'},{parameters:arguments});};