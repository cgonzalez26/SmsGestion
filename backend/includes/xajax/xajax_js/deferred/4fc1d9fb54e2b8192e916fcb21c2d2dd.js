...
xjx.$=xajax.tools.$;xjx.getFormValues=xajax.tools.getFormValues;xjx.request=xajax.request;if('undefined'==typeof JSON)xajax.js.includeScript({data:xajax.config.JavaScriptURI+'xajax_js/JSON.js'});xajax_getDatosContacto=function(){return xajax.request({xjxfun:'getDatosContacto'},{parameters:arguments});};xajax_enviarSMSRapido=function(){return xajax.request({xjxfun:'enviarSMSRapido'},{parameters:arguments});};xajax_buscarMensajesSMS=function(){return xajax.request({xjxfun:'buscarMensajesSMS'},{parameters:arguments});};xajax_obtenerGanador=function(){return xajax.request({xjxfun:'obtenerGanador'},{parameters:arguments});};