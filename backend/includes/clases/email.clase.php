...
//--------------------------------------------------------------------	
	...
	function inicializar( $to = '', $from = '', $from_ip = '') {
		...
		$this->cabeceras = "From: Seguros <$from_default>\r\n";
...
function configuraciones_get() {
	...
	$array['login_login'] = 'infomail@grupoaldazabal.com.ar';
	$array['login_pass'] = '1nfoma1l';

	$array['from_default'] = 'infomail@grupoaldazabal.com.ar';
