<?php 
	...
	//$aParametros['MOSTRAR_REFRESH'] = "<meta http-equiv=\"Refresh\" content=\"30;url=MensajesRecibidos.php\">";
	if($_GET['idMensaje']){
		$aOpciones['ID_MENSAJE'] = $_GET['idMensaje'];
	}
	...
	$body = xhtmlTablaABM($aOpciones,'MensajesRecibidos');
