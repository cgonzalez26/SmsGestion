<?php 
	...
	$oXajax->register( XAJAX_FUNCTION , 'getDatosUnidadNegocio');
	$oXajax->register( XAJAX_FUNCTION , 'updateDatosUnidadNegocio');	
	...
	$body = xhtmlTablaABM($aOpciones,'UnidadesNegocios');
